...
key31=0; %when key3 =1: 1 produses a plot with s polarised light and 2 produces a plot with p polarised light
key4=4; %what is beeing varied (1 varys R, 2 varys a, 3 varys hs, 4 varys hf,5 varys angl)
...
elseif key4==4  %varying hf
    [hs1,hs2,hs3]=deal(hs);
    [Rad1,Rad2,Rad3]=deal(Rad);
    [hf1,hf2,hf3]=deal(200,500,50000);
    [a1,a2,a3]=deal(Rad*aconst);
    [alofi1,alofi2,alofi3]=deal(alofi);
    ver="hf=";
...
elseif key3==2
    ...
    [RSnoHMMr1,RPnoHMMr1,TSnoHMMr1,TPnoHMMr1,ASnoHMMr1,APnoHMMr1,wavelengthnoHMMr1,var1noHMMr1,var2noHMMr1] = spectrum_anisotropic_nw_5L(Rad1,dep,hs1,alofi1,a1,0,nwa,ucA,key1);
    [RSnoHMMr2,RPnoHMMr2,TSnoHMMr2,TPnoHMMr2,ASnoHMMr2,APnoHMMr2,wavelengthnoHMMr2,var1noHMMr2,var2noHMMr2] = spectrum_anisotropic_nw_5L(Rad2,dep,hs2,alofi2,a2,0,nwa,ucA,key1);
    [RSnoHMMr3,RPnoHMMr3,TSnoHMMr3,TPnoHMMr3,ASnoHMMr3,APnoHMMr3,wavelengthnoHMMr3,var1noHMMr3,var2noHMMr3] = spectrum_anisotropic_nw_5L(Rad3,dep,hs3,alofi3,a3,0,nwa,ucA,key1);
end
...
elseif key3==2 &&key4~=5
    ...
    hold on
    plot(p1,wavelengthr1,RSr1*100,'r','DisplayName',char(append("RS",string(key2))))
    plot(p1,wavelengthr1,RSnoNPr1*100,'b--','DisplayName',char(append("RS",string(key2),"  no NP")))
    plot(p1,wavelengthr1,RSnoHMMr1*100,'k-.','DisplayName',char(append("RS",string(key2),"  no HMM")))
    hold off
%     xlabel(p1,'wavelength (nm)')
    ylabel(p1,'Reflectance (%)')
%     legend(p1,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    ...
    plot(p4,wavelengthr2,RSnoNPr2*100,'b--','DisplayName',char(append("RS",string(key2),"  no NP")))
    plot(p4,wavelengthr2,RSnoHMMr2*100,'k-.','DisplayName',char(append("RS",string(key2),"  no HMM")))
    hold off
...
%     legend(p4,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    ...
    plot(p7,wavelengthr3,RSnoNPr3*100,'b--','DisplayName',char(append("RS",string(key2),"  no NP")))
    plot(p7,wavelengthr3,RSnoHMMr3*100,'k-.','DisplayName',char(append("RS",string(key2),"  no HMM")))
    
    hold off
%     xlabel(p7,'wavelength (nm)')
%     ylabel(p7,'Reflectance (%)')
%     legend(p7,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    ...
    p2=nexttile;
    hold on
    plot(p2,wavelengthr1,TSr1*100,'r','DisplayName',char(append("TS",string(key2))))
    plot(p2,wavelengthr1,TSnoNPr1*100,'b--','DisplayName',char(append("TS",string(key2),"  no NP")))
    plot(p2,wavelengthr1,TSnoHMMr1*100,'k-.','DisplayName',char(append("TS",string(key2),"  no HMM")))
    hold off
%     xlabel(p2,'wavelength (nm)')
    ylabel(p2,'Transmition (%)')
%     legend(p2,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    axis([300 800 0 100])
    xline(p2,lin1);
    xline(p2,lin2);
    xline(p2,lin3);
    ...
    p5=nexttile;
    hold on
%     plot(p5,wavelengthr2,TSr2*100,'r','DisplayName',char(append("TS",string(key2))))
%     plot(p5,wavelengthr2,TSnoNPr2*100,'b--','DisplayName',char(append("TS",string(key2),"  no NP")))
%     plot(p5,wavelengthr2,TSnoHMMr2*100,'k-.','DisplayName',char(append("TS",string(key2),"  no HMM")))
    plot(p5,wavelengthr2,TSr2*100,'r','DisplayName',char("with NP and HMM"))
    plot(p5,wavelengthr2,TSnoNPr2*100,'b--','DisplayName',char(append("no NP")))
    plot(p5,wavelengthr2,TSnoHMMr2*100,'k-.','DisplayName',char(append("no HMM")))
    hold off
%     xlabel(p5,'wavelength (nm)')
%     ylabel(p5,'Transmition (%)')
    legend(p5,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    axis([300 800 0 100])
    xline(p5,lin1);
    xline(p5,lin2);
    xline(p5,lin3);
    ...
    p8=nexttile;
    hold on
    plot(p8,wavelengthr3,TSr3*100,'r','DisplayName',char(append("TS",string(key2))))
    plot(p8,wavelengthr3,TSnoNPr3*100,'b--','DisplayName',char(append("TS",string(key2),"  no NP")))
    plot(p8,wavelengthr3,TSnoHMMr3*100,'k-.','DisplayName',char(append("TS",string(key2),"  no HMM")))
    hold off
%     xlabel(p8,'wavelength (nm)')
%     ylabel(p8,'Transmition (%)')
%     legend(p8,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    axis([300 800 0 100])
    xline(p8,lin1);
    xline(p8,lin2);
    xline(p8,lin3);
    ...
    p3=nexttile;
    hold on
    plot(p3,wavelengthr1,ASr1*100,'r','DisplayName',char(append("AS",string(key2))))
    plot(p3,wavelengthr1,ASnoNPr1*100,'b--','DisplayName',char(append("AS",string(key2),"  no NP")))
    plot(p3,wavelengthr1,ASnoHMMr1*100,'k-.','DisplayName',char(append("AS",string(key2),"  no HMM")))
    hold off
...
%     legend(p3,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    ...
    p6=nexttile;
    hold on
    plot(p6,wavelengthr2,ASr2*100,'r','DisplayName',char(append("AS",string(key2))))
    plot(p6,wavelengthr2,ASnoNPr2*100,'b--','DisplayName',char(append("AS",string(key2),"  no NP")))
    plot(p6,wavelengthr2,ASnoHMMr2*100,'k-.','DisplayName',char(append("AS",string(key2),"  no HMM")))   
    hold off
...
%     legend(p6,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    ...
    p9=nexttile;
    hold on
    plot(p9,wavelengthr3,ASr3*100,'r','DisplayName',char(append("AS",string(key2))))
    plot(p9,wavelengthr3,ASnoNPr3*100,'b--','DisplayName',char(append("AS",string(key2),"  no NP")))
    plot(p9,wavelengthr3,ASnoHMMr3*100,'k-.','DisplayName',char(append("AS",string(key2),"  no HMM")))
    hold off
    xlabel(p9,'wavelength (nm)')
%     ylabel(p9,'Absorbance (%)')
%     legend(p9,'Location','northeast','NumColumns',1,'AutoUpdate', 'off')
    axis([300 800 0 100])
    xline(p9,lin1);
    xline(p9,lin2);
    xline(p9,lin3);
elseif key3==2 &&key4==5 && key31~=0
    tiledlayout(1,1);
    if key31==1
        p1=nexttile;
        hold on
    ...
    p1=nexttile;
    hold on
    plot(p1,wavelengthr1,RSr1*100,'k','DisplayName',char(append("alofi=",string(alofi1))))
    plot(p1,wavelengthr1,RSr2*100,'b--','DisplayName',char(append("s-pol alofi=",string(alofi2))))
    plot(p1,wavelengthr1,RSr3*100,'b-.','DisplayName',char(append("s-pol alofi=",string(alofi3))))
%     plot(p1,wavelengthr1,RPr2*100,'r--','DisplayName',char(append("p-pol alofi=",string(alofi2))))
%     plot(p1,wavelengthr1,RPr3*100,'r-.','DisplayName',char(append("p-pol alofi=",string(alofi3))))
    ...
    p2=nexttile;
    hold on
    plot(p2,wavelengthr1,TSr1*100,'k','DisplayName',char(append("alofi=",string(alofi1))))
    plot(p2,wavelengthr1,TSr2*100,'b--','DisplayName',char(append("s-pol alofi=",string(alofi2))))
    plot(p2,wavelengthr1,TSr3*100,'b-.','DisplayName',char(append("s-pol alofi=",string(alofi3))))
%     plot(p2,wavelengthr1,TPr2*100,'r--','DisplayName',char(append("p-pol alofi=",string(alofi2))))
%     plot(p2,wavelengthr1,TPr3*100,'r-.','DisplayName',char(append("p-pol alofi=",string(alofi3))))
...
% %     legend(p1,'Location','northwest','NumColumns',1,'AutoUpdate', 'off')
    ...
    p3=nexttile;
    hold on
    plot(p3,wavelengthr1,ASr1*100,'k','DisplayName',char(append("alofi=",string(alofi1))))
    plot(p3,wavelengthr1,ASr2*100,'b--','DisplayName',char(append("s-pol alofi=",string(alofi2))))
    plot(p3,wavelengthr1,ASr3*100,'b-.','DisplayName',char(append("s-pol alofi=",string(alofi3))))
%     plot(p3,wavelengthr1,APr2*100,'r--','DisplayName',char(append("p-pol alofi=",string(alofi2))))
%     plot(p3,wavelengthr1,APr3*100,'r-.','DisplayName',char(append("p-pol alofi=",string(alofi3))))
    ...
    xline(p3,lin3);
     ...
     p5=nexttile;
    hold on
    plot(p5,wavelengthr1,RSr1*100,'k','DisplayName',char(append("alofi=",string(alofi1))))
%     plot(p5,wavelengthr1,RSr2*100,'b--','DisplayName',char(append("s-pol alofi=",string(alofi2))))
%     plot(p5,wavelengthr1,RSr3*100,'b-.','DisplayName',char(append("s-pol alofi=",string(alofi3))))
    plot(p5,wavelengthr1,RPr2*100,'r--','DisplayName',char(append("p-pol alofi=",string(alofi2))))
    plot(p5,wavelengthr1,RPr3*100,'r-.','DisplayName',char(append("p-pol alofi=",string(alofi3))))
    ...
    p4=nexttile;
    hold on
    plot(p4,wavelengthr1,TSr1*100,'k','DisplayName',char(append("alofi=",string(alofi1))))
%     plot(p4,wavelengthr1,TSr2*100,'b--','DisplayName',char(append("s-pol alofi=",string(alofi2))))
%     plot(p4,wavelengthr1,TSr3*100,'b-.','DisplayName',char(append("s-pol alofi=",string(alofi3))))
    plot(p4,wavelengthr1,TPr2*100,'r--','DisplayName',char(append("p-pol alofi=",string(alofi2))))
    plot(p4,wavelengthr1,TPr3*100,'r-.','DisplayName',char(append("p-pol alofi=",string(alofi3))))   
    hold off
    xlabel(p4,'wavelength (nm)')
...
% %     legend(p1,'Location','northwest','NumColumns',1,'AutoUpdate', 'off')
    ...
    p6=nexttile;
    hold on
    plot(p6,wavelengthr1,ASr1*100,'k','DisplayName',char(append("alofi=",string(alofi1))))
%     plot(p6,wavelengthr1,ASr2*100,'b--','DisplayName',char(append("s-pol alofi=",string(alofi2))))
%     plot(p6,wavelengthr1,ASr3*100,'b-.','DisplayName',char(append("s-pol alofi=",string(alofi3))))
    plot(p6,wavelengthr1,APr2*100,'r--','DisplayName',char(append("p-pol alofi=",string(alofi2))))
    plot(p6,wavelengthr1,APr3*100,'r-.','DisplayName',char(append("p-pol alofi=",string(alofi3))))

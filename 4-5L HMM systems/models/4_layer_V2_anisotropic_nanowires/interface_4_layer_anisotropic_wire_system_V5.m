...
%keys
key1=2; %controles what the image charge screening factor (eta) is: f 2 all imaginary parts of sqrt(epspllepsper) are made positive, if 1 eta contains the imaginary parts if 0.5 eta contains only the real parts if 0 then eta is 0 is on or off
...
key6=1; %location of the ledgend (0: topleft, 1: topright 2: bottomright)
key7=1;

if key7==1
    lin1=370; %plots a vertical line at a given wavelength
    lin2=517.5; %plots a vertical line at a given wavelength
    lin3=541; %plots a vertical line at a given wavelength
elseif key7==0
    lin1=0; %plots a vertical line at a given wavelength
    lin2=0; %plots a vertical line at a given wavelength
    lin3=0; %plots a vertical line at a given wavelength
end
line1=0; %plots a vertical line at a given wavelength
%constants
Rad=20;    %radius of NP
dep=1;     %thickness of layer 2
hs=1;      %hight of layer 3
alofi=0;   %angel of incident light
aconst=5;  %lattice constant
a=Rad*aconst;
...
if key2~=0
    ...
    if key2~=4
        ...
        %angli=0
        if key4==1
            [RSr11,RPr11,wavelength0r11,epsper0r11,epspll0r11]=spectrum_anisotropic_nw_V3(Rad1,dep,hs1,alofi1,a1,nwa,ucA,key1);
        [RSr21,RPr21,wavelength0r21,epsper0r21,epspll0r21]=spectrum_anisotropic_nw_V3(Rad2,dep,hs2,alofi1,a2,nwa,ucA,key1);
        [RSr31,RPr31,wavelength0r31,epsper0r31,epspll0r31]=spectrum_anisotropic_nw_V3(Rad3,dep,hs3,alofi1,a3,nwa,ucA,key1);
        [RSr41,RPr41,wavelength0r41,epsper0r41,epspll0r41]=spectrum_anisotropic_nw_V3(Rad4,dep,hs4,alofi1,a4,nwa,ucA,key1);
        [RSr51,RPr51,wavelength0r51,epsper0r51,epspll0r51]=spectrum_anisotropic_nw_V3(Rad5,dep,hs5,alofi1,a5,nwa,ucA,key1);
        [RSr61,RPr61,wavelength0r61,epsper0r61,epspll0r61]=spectrum_anisotropic_nw_V3(Rad6,dep,hs6,alofi1,a6,nwa,ucA,key1);
        else
        [RSr11,RPr11,wavelength0r11,epsper0r11,epspll0r11]=spectrum_anisotropic_nw_V3(Rad1,dep,hs1,alofi1,a1,nwa,ucA,key1);
        [RSr21,RPr21,wavelength0r21,epsper0r21,epspll0r21]=spectrum_anisotropic_nw_V3(Rad2,dep,hs2,alofi1,a2,nwa,ucA,key1);
        [RSr31,RPr31,wavelength0r31,epsper0r31,epspll0r31]=spectrum_anisotropic_nw_V3(Rad3,dep,hs3,alofi1,a3,nwa,ucA,key1);
        ...
        [RSr61,RPr61,wavelength0r61,epsper0r61,epspll0r61]=spectrum_anisotropic_nw_V3(Rad6,dep,hs6,alofi1,a6,nwa,ucA,key1);
        %angli=20
        [RSr12,RPr12,wavelength0r12,epsper0r12,epspll0r12]=spectrum_anisotropic_nw_V3(Rad1,dep,hs1,alofi2,a1,nwa,ucA,key1);
        [RSr22,RPr22,wavelength0r22,epsper0r22,epspll0r22]=spectrum_anisotropic_nw_V3(Rad2,dep,hs2,alofi2,a2,nwa,ucA,key1);
        [RSr32,RPr32,wavelength0r32,epsper0r32,epspll0r32]=spectrum_anisotropic_nw_V3(Rad3,dep,hs3,alofi2,a3,nwa,ucA,key1);
        [RSr42,RPr42,wavelength0r42,epsper0r42,epspll0r42]=spectrum_anisotropic_nw_V3(Rad4,dep,hs4,alofi2,a4,nwa,ucA,key1);
        [RSr52,RPr52,wavelength0r52,epsper0r52,epspll0r52]=spectrum_anisotropic_nw_V3(Rad5,dep,hs5,alofi2,a5,nwa,ucA,key1);
        [RSr62,RPr62,wavelength0r62,epsper0r62,epspll0r62]=spectrum_anisotropic_nw_V3(Rad6,dep,hs6,alofi2,a6,nwa,ucA,key1);
        %angli=60
        [RSr13,RPr13,wavelength0r13,epsper0r13,epspll0r13]=spectrum_anisotropic_nw_V3(Rad1,dep,hs1,alofi3,a1,nwa,ucA,key1);
        [RSr23,RPr23,wavelength0r23,epsper0r23,epspll0r23]=spectrum_anisotropic_nw_V3(Rad2,dep,hs2,alofi3,a2,nwa,ucA,key1);
        [RSr33,RPr33,wavelength0r33,epsper0r33,epspll0r33]=spectrum_anisotropic_nw_V3(Rad3,dep,hs3,alofi3,a3,nwa,ucA,key1);
        [RSr43,RPr43,wavelength0r43,epsper0r43,epspll0r43]=spectrum_anisotropic_nw_V3(Rad4,dep,hs4,alofi3,a4,nwa,ucA,key1);
        [RSr53,RPr53,wavelength0r53,epsper0r53,epspll0r53]=spectrum_anisotropic_nw_V3(Rad5,dep,hs5,alofi3,a5,nwa,ucA,key1);
        [RSr63,RPr63,wavelength0r63,epsper0r63,epspll0r63]=spectrum_anisotropic_nw_V3(Rad6,dep,hs6,alofi3,a6,nwa,ucA,key1);
        end 
        [RSrnoNP,RPrnoNP,wavelength0rnoNP,epsper0rnoNP,epspll0rnoNP]=spectrum_anisotropic_nw_V3(0.0000000001,dep,hs,alofi1,a,nwa,ucA,key1);
    elseif key2==4
        [RSr11,RPr11,wavelength0r11,epsper0r11,epspll0r11]=spectrum_anisotropic_nw_V3(Rad1,dep,hs1,alofi1,a1,nwa,ucA,key1);
        [RSr21,RPr21,wavelength0r21,epsper0r21,epspll0r21]=spectrum_anisotropic_nw_V3(Rad2,dep,hs2,alofi2,a2,nwa,ucA,key1);
        [RSr31,RPr31,wavelength0r31,epsper0r31,epspll0r31]=spectrum_anisotropic_nw_V3(Rad3,dep,hs3,alofi3,a3,nwa,ucA,key1);
    end
    figure;
...
%         plot(p1,wavelength0r51,RSr51*100,'DisplayName',char(append(RS,', ',ver,string(ver5))));
    ...
    elseif key6==3
        legend(p1,'Location','northwest','NumColumns',2,'AutoUpdate', 'off')
    end
    xline(p1,lin1);
    xline(p1,lin2);
    xline(p1,lin3);
...
elseif key2==0
    [RSr,RPr,wavelengthr,var1,var2]=spectrum_anisotropic_nw_V3(Rad,dep,hs,alofi,a,nwa,ucA,key1);
    eta=var1;
    epsper4=var2{1};
    epspll4=var2{2};
    eps4sq=var2{3};
    ...
    xlabel(p4,'wavelength')
    ylabel(p1,'%')
    legend(p4,'Location','southeast','NumColumns',1,'AutoUpdate', 'off')
    xline(p4,line1);
    yline(p4,0);

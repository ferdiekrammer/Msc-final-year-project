...
for i=1:length(angl)
    ...
    einf4d=epsSE(B1,B2,B3,C1,C2,C3,w); 
    ...
    [eps4pll,eps4per]=epsaniso_wires(einf4m,ew_pD4m,eg_D4m,es14m,ew_p1L4m,eg_1L4m,es24m,ew_p2L4m,eg_2L4m,einf4d,ew_pD4d,eg_D4d,es14d,ew_p1L4d,eg_1L4d,es24d,ew_p2L4d,eg_2L4d,nwa,ucA,w);

...
% This is the model scrip which is run by all other scripst when outputing
% the results 

%equations fail if halfspace is metal in nature

%electric permiativity for layer 1
e1=1.78;

%electric permiativity for layer 2 (NP) (Gold NP)
einf2=5.9752;
ew_pD2=8.8667;
eg_D2=0.03799;
es12=1.76;
...
% electric permiativity of layer 5 (material on which HMM is mounted)

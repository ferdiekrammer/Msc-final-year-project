...
[md1,md2,md3,md4,md5]=deal(key21/100,key22/100,key23/100,key24/100,key25/100);     %thickness of metal sheets
[dd1,dd2,dd3,dd4,dd5]=deal(1-md1,1-md2,1-md3,1-md4,1-md5);                         %thickness of dielectric sheets
[hs1,hs2,hs3]=deal(hs);         %thikness of layer 3 (the gap between np and HMM)
[Rad1,Rad2,Rad3]=deal(Rad);     %Radius of NP

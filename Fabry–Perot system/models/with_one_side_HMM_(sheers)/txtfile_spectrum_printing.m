...
fileID = fopen(char(append("theory_sheets_HMMhf=",string(hf2),"nm_tophf=",string(hf1),"nm_ff",string(key2),"_NP_R=",string(Rad),"_a=",string(aconst),"R_h=",string(hs),"_d=",string(dep),"L=",string(L),"nm_V2.txt")),'w');

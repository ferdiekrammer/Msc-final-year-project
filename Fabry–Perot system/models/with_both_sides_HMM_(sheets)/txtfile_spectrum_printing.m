...
fileID = fopen(char(append("theory_sheets_HMMhf=",string(hf),"nm_ff",string(key2),"_NP_R=",string(Rad),"_a=",string(aconst),"R_h=",string(hs),"_d=",string(dep),"L=",string(L),"nm.txt")),'w');

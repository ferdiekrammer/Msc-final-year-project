...
ylabel(p1,'Transmitance %')
title(p1,'Au NP R=20 nm')
axis([300 800 0 70])
legend(p1,{'a=2.5R' 'a=3R' 'a=3.5R' 'a=5R' 'no NP'},'Location','northeast','NumColumns',1)

p2=nexttile;
plot(wavelengthr1,R2)
hold off
xlabel(p2,'wavelength (nm)')
ylabel(p2,'Transmitance %')
title(p2,'Au NP R=10 nm')
axis([300 800 0 70])
legend(p2,{'a=2.5R' 'a=3R' 'a=3.5R' 'a=5R' 'no NP'},'Location','northeast','NumColumns',1)
% p1=nexttile;
% 
% R=[TSr1(:)*100 TSr2(:)*100 TSr3(:)*100 TSr4(:)*100 TSnoNPr1(:)*100];

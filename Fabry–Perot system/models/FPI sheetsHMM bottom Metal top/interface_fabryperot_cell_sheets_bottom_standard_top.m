...
[RSnoNPr1,RPnoNPr1,TSnoNPr1,TPnoNPr1,ASnoNPr1,APnoNPr1,wavelengthnoNPr1,var1noNPr1,var2noNPr1] = spectrum_anisotropic_fabryperot_sheets_bottom(0.000000001,dep,hs,alofi,a,hf1,hf2,L,md,dd,key1);
...
plot(p3,wavelengthr1,ASnoNPr1*100,'--','DisplayName',char(append("TS",string(key2),"  no NP")))
hold off

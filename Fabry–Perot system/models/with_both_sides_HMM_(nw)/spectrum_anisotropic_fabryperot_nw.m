function [RS,RP,TS,TP,AS,AP,wavelength,var1,var2] = spectrum_anisotropic_fabryperot_nw(R,d,hs,alofi,a,hf,L,nwa,ucA,key1)
...
%     einfd=epsSE(B1,B2,B3,C1,C2,C3,w(i));
    ...
    [eps8pll,eps8per]=epsaniso_wires(einfm,ew_pDm,eg_Dm,es1m,ew_p1Lm,eg_1Lm,es2m,ew_p2Lm,eg_2Lm,einfd,ew_pDd,eg_Dd,es1d,ew_p1Ld,eg_1Ld,es2d,ew_p2Ld,eg_2Ld,nwa,ucA,w(i));

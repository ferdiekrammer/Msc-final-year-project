...
plot(p1,wavelengthr1,RSr1*100,'--','DisplayName',char(append("a=3R")))

hold off
xlabel(p1,'wavelength (nm)')
ylabel(p1,'Reflection %')
% title(p1,'Au NP R=20 nm')
axis([300 800 0 100])
...
plot(p2,wavelengthr1,TSr1*100,'--','DisplayName',char(append("a=3R")))


hold off
xlabel(p2,'wavelength (nm)')
ylabel(p2,'Transmitance %')
% title(p2,'Au NP R=20 nm')
axis([300 800 0 100])
...
plot(p3,wavelengthr1,ASr1*100,'--','DisplayName',char(append("a=3R")))


hold off
xlabel(p3,'wavelength (nm)')
ylabel(p3,'Absorbance %')
% title(p3,'Au NP R=20 nm')
axis([300 800 0 100])
legend('Location','northeast','NumColumns',1)

% [RSr1,RPr1,TSr1,TPr1,ASr1,APr1,wavelengthr1,var1r1,var2r1] = spectrum_anisotropic_fabryperot_sheets(Rad,dep,hs,alofi,Rad*2.5,hf,L,md,dd,key1);
% [RSr2,RPr2,TSr2,TPr2,ASr2,APr2,wavelengthr2,var1r2,var2r2] = spectrum_anisotropic_fabryperot_sheets(Rad,dep,hs,alofi,Rad*3,hf,L,md,dd,key1);
% [RSr3,RPr3,TSr3,TPr3,ASr3,APr3,wavelengthr3,var1r3,var2r3] = spectrum_anisotropic_fabryperot_sheets(Rad,dep,hs,alofi,Rad*3.5,hf,L,md,dd,key1);
% [RSr4,RPr4,TSr4,TPr4,ASr4,APr4,wavelengthr4,var1r4,var2r4] = spectrum_anisotropic_fabryperot_sheets(Rad,dep,hs,alofi,Rad*5,hf,L,md,dd,key1);
...
% 
% [RSr12,RPr12,TSr12,TPr12,ASr12,APr12,wavelengthr12,var1r12,var2r12] = spectrum_anisotropic_fabryperot_sheets(Rad2,dep2,hs,alofi,Rad*2.5,hf,L,md,dd,key1);
% [RSr22,RPr22,TSr22,TPr22,ASr22,APr22,wavelengthr22,var1r22,var2r22] = spectrum_anisotropic_fabryperot_sheets(Rad2,dep2,hs,alofi,Rad*3,hf,L,md,dd,key1);
% [RSr32,RPr32,TSr32,TPr32,ASr32,APr32,wavelengthr32,var1r32,var2r32] = spectrum_anisotropic_fabryperot_sheets(Rad2,dep2,hs,alofi,Rad*3.5,hf,L,md,dd,key1);
% [RSr42,RPr42,TSr42,TPr42,ASr42,APr42,wavelengthr42,var1r42,var2r42] = spectrum_anisotropic_fabryperot_sheets(Rad2,dep2,hs,alofi,Rad*5,hf,L,md,dd,key1);
